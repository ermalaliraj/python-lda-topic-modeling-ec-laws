...
fileDocumentsArr = './model/lda_model_EU_REG_year-' + year + '_nrtopics' + str(num_topics) + '_documentsArr.pkl'
...
print(len(corpus_words), "documents,", 1111, "words,", len(id2word), "id2word size for full corpus")
